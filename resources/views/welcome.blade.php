...
<body class="bg-default">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar-default_dropdown_1">
                                <a class="dropdown-item" href="/home">สำหรับบุคลากร</a>
                                <a class="dropdown-item" href="/admin">สำหรับผู้ดูแล</a>
                            </div>
                        </li>
                        @else
                        <li class="nav-item">
    ...
    <footer class="py-5">
        <div class="container">
            <div class="row align-items-center justify-content-xl-between m-3" style="position: fixed; bottom: 0; right:0; left:0;">
                <div class="col-xl-6">
    ...
    <div style="position:fixed; bottom: 0; right: 0; margin: 10px">
        ...
        <div class="text-center alert alert-{{ session()->get('alert_color') }}" style="margin-bottom: 0;" role="alert"
            id="alert">{{ session()->get('alert_text') }}</div>
        @endif
    </div>
    ...
    <script>
        ...
        typewriter.typeString('Document delivery system for appointment of academic position.')
            .pauseFor(2500)
            .deleteAll()
            .typeString('Case study of Rajamangala university of technology Isan Sakonnakhon campus.')
            .pauseFor(2500)
            .deleteAll()
            .start()
    </script>
